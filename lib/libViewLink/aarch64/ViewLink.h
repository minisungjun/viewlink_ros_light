 ...
 *          This SDK is suitable for use with F, T, TL, TIR, TIRM, TM, Z-fusionS, Z6KA7, XIR, ZIR, QIR19, Z36N,
 ...
 *  @param pConnParam connect information, including connection type (TCP or serial port or UDP), ip address, port,
 * serial port name, baudrate
 *  @param pUdpConnParam connect information, including connection type (UDP), UDP Local ip address, port, serial port
 * name, baudrate
